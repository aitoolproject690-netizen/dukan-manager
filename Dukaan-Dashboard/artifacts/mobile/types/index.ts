...
export interface CartItem { product_id:string|null; product_name:string; quantity:number; price:number; purchase_price:number; unit:string; }
export interface AppSettings { business_name:string; business_phone:string; business_address:string; business_gstn:string; pin_enabled:boolean; fingerprint_enabled:boolean; dark_mode:'system'|'light'|'dark'; upi_id:string; low_stock_alerts:boolean; invoice_prefix:string; currency_symbol:string; }
export const DEFAULT_SETTINGS:AppSettings={business_name:'My Dukaan',business_phone:'',business_address:'',business_gstn:'',pin_enabled:false,fingerprint_enabled:false,dark_mode:'system',upi_id:'',low_stock_alerts:true,invoice_prefix:'INV',currency_symbol:'₹'};
export const EXPENSE_CATEGORIES=['Rent','Electricity','Salaries','Transport','Raw Material','Maintenance','Marketing','Packaging','Miscellaneous'];
